...
insert into skill_tb (skill) values('Python');
insert into skill_tb (skill) values('C++');
insert into skill_tb (skill) values('Kotlin');
insert into skill_tb (skill) values('Swift');
insert into skill_tb (skill) values('MySQL');
insert into skill_tb (skill) values('jQuery');
insert into skill_tb (skill) values('HTML');
insert into skill_tb (skill) values('Flutter');
insert into skill_tb (skill) values('JSP');
insert into skill_tb (skill) values('React');
insert into skill_tb (skill) values('React Native');
insert into skill_tb (skill) values('Vue.js');
insert into skill_tb (skill) values('OpenCV');
insert into skill_tb (skill) values('PyTorch');
insert into skill_tb (skill) values('Oracle');
insert into skill_tb (skill) values('AWS');
...
insert into position_tb (position) values('빅데이터 엔지니어');
insert into position_tb (position) values('인공지능/머신러닝');
insert into position_tb (position) values('QA 엔지니어');
insert into position_tb (position) values('개발 PM');
insert into position_tb (position) values('웹 퍼블리셔');
insert into position_tb (position) values('VR/AR/3D');
insert into position_tb (position) values('기술지원');
...
insert into required_position_tb (position_id, job_opening_id) values ('4', '2');
insert into required_position_tb (position_id, job_opening_id) values ('1', '3');
insert into required_position_tb (position_id, job_opening_id) values ('5', '3');
